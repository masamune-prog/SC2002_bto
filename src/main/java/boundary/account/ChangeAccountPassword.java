...
public class ChangeAccountPassword {
     ...
     */
    public static void askToRetry(UserType userType, String userNRIC) throws PageBackException {
        ...
        if (choice.equals("b")) {
            ...
            changePassword(userType, userNRIC);
        }
    }
     ...
     * @throws PageBackException if the user chooses to go back
     */
    public static void changePassword(UserType userType, String userNRIC) throws PageBackException {
        ...
        try {
            AccountManager.login(userType, userNRIC, oldPassword);
        } catch (ModelNotFoundException e) {
            throw new RuntimeException(e);
        } catch (PasswordIncorrectException e) {
            System.out.println("Password incorrect.");
            askToRetry(userType, userNRIC);
        }
        ...
        try {
            AccountManager.changePassword(userType, userNRIC, oldPassword, newPassword);
